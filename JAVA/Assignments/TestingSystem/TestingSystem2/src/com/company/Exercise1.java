...
public class Exercise1 {
    public static void main(String[] args) {
        ...
        exam1.createDate = LocalDate.of(2021,1,30);
        ...
        exam3.createDate = LocalDate.of(2021,6,10);
...
//
// //Question 3:
// System.out.println(account2.department == null ? "Nhân viên này không có phòng ban" : "Phòng ban của nhân viên này là: " + account2.department.departmentName);
//
//
// //Question 4:
// System.out.println(account1.position.positionName == PositionName.DEV? "Đây là Developer" : "Người này không phải Developer");
//
//
// //Question 5:
...
//         break;
//     case 2:
//         System.out.print("Group của nhân viên này là Java Fresher, C# Fresher");
//         break;
//     case 3:
//         System.out.println("Nhân viên này là người quan trọng, tham gia nhiều group");
//         break;
...
//
// //Question 9:
// Department[] depList = {department1,department2,department3};
// for (Department depInfor: depList) {
//     System.out.println("Department ID: " + depInfor.departmentID + " Department Name: "+ depInfor.departmentName);
// }
//
//
// //Question 10:
...
//     System.out.println("Email: " + accList[i].email);
//     System.out.println("Full Name: " + accList[i].fullName);
//     System.out.println("Phòng ban: " + accList[i].department.departmentName);
//     System.out.println();
// }
//
//
...
//     System.out.println("ID: "+depList[i].departmentID);
//     System.out.println("Name: "+depList[i].departmentName);
//     System.out.println();
// }
//
//
