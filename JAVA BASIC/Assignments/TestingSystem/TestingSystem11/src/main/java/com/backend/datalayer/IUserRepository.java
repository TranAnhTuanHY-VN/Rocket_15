...
/**
 * This class is interface of Account Repository.
 * @author: TranAnhTuan
 */
public interface IUserRepository {
     ...
     * @author TranAnhTuan
     */
    void createAccount(String username, String fullName) throws SQLException, ClassNotFoundException;
     ...
     * @author TranANhTuan
     */
    void updateAccountFullNameByID(int id, String newFullName) throws SQLException, ClassNotFoundException;
